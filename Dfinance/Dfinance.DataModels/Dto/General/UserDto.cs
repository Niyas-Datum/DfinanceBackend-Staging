...

{
...

    {
        ...
        public DropdownDto Designation { get; set; }

        public bool? Active { get; set; }

        [Required(ErrorMessage = "Employee Type is required")]

        public DropdownDto EmployeeType { get; set; }
...

    {
        ...
        public DropdownDto? DepartmentName { get; set; }

        public byte? ActiveFlag { get; set; }

        public bool IsMainBranch { get; set; }

        public DropdownDto? BranchName { get; set; }

        public DropdownDto? Supervisor { get; set; }
