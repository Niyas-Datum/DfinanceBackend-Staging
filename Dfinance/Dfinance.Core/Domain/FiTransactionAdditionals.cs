...
namespace Dfinance.Core
{
    public class FiTransactionAdditionals
    {
        ...
        public int? ProvisionalAccount { get; set; }

        public virtual FiMaAccount? Account { get; set; }
        public virtual FiMaAccount? AccountId2Navigation { get; set; }
        public virtual MaArea? Area { get; set; }
        public virtual MaMisc? CountryOfOrigin { get; set; }
        public virtual MaDepartment? Department { get; set; }
       // public virtual Firm? Firm { get; set; }
       // public virtual Location? FromLocation { get; set; }
        //public virtual Location? InLoc { get; set; }
        public virtual MaMisc? Mode { get; set; }
        public virtual MaCompany? OtherBranch { get; set; }
        //public virtual Location? OutLoc { get; set; }
        public virtual MaCompany? PostedBranch { get; set; }
        public virtual MaPriceCategory? PriceCategory { get; set; }
        public virtual MaEmployee? RecommendBy { get; set; }
       // public virtual FiTransaction? RefTransId1Navigation { get; set; }
        //public virtual MaRoute? Route { get; set; }
       // public virtual Location? ToLocation { get; set; }
        public virtual FiTransaction Transaction { get; set; } = null!;
        public virtual MaMisc? Type { get; set; }
    }
}
