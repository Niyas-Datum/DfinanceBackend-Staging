...
namespace Dfinance.NUnitTest.Purchase
{
    ...
    {
        private Mock<IPurchaseOrderService> _purchaseOrderMock;
        [SetUp]
        public void Setup()
        {
                ...
                Items = new List<InvTransItemDto>
    {
                    ...
                    Cash = new List<InvAccountDetailsDto>
        {
            ...
            _purchaseOrderMock.Setup(x => x.SavePurchaseOrder(invTransDto, pageId, voucherId)).Returns(new CommonResponse { Exception = null, Data = new InventoryTransactionDto() });
            var result = _purchaseOrderMock.Object.SavePurchaseOrder(invTransDto, pageId, voucherId);
                ...
                Items = new List<InvTransItemDto>
    {
                    ...
                    Cash = new List<InvAccountDetailsDto>
        {
            ...
            _purchaseOrderMock.Setup(x => x.UpdatePurchaseOrder(invTransDto, pageId, voucherId)).Returns(new CommonResponse { Exception = null, Data = new InventoryTransactionDto() });
            var result = _purchaseOrderMock.Object.UpdatePurchaseOrder(invTransDto, pageId, voucherId);
            Assert.That(result, Is.Not.Null);
            Assert.That(result.IsValid, Is.True);
            Assert.That(result.Data, Is.Not.Null);
        }
        ...
        public void DeletePurchaseOrderTest()
        {
            int transId = 31;
            int pageId = 231;
            _purchaseOrderMock.Setup(x => x.DeletePurchaseOrder(transId,pageId)).Returns(new CommonResponse { Exception = null, Data = new InventoryTransactionDto() });
            var result = _purchaseOrderMock.Object.DeletePurchaseOrder(transId, pageId);
            Assert.That(result, Is.Not.Null);
            Assert.That(result.IsValid, Is.True);
            Assert.That(result.Data, Is.Not.Null);
