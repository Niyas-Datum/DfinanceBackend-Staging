...
{
    public class PurchaseQtnTest
    {
        private Mock<IPurchaseQuotationService> _purchaseQtnMock;
        [SetUp]
        public void Setup()
        {
            _purchaseQtnMock = new Mock<IPurchaseQuotationService>();
        }

        [Test]
        public void SavePurchaseQtnTest()
        {
            int voucherId = 161;
            int pageId = 526;
                ...
                Items = new List<InvTransItemDto>
    {
                    ...
                    Cash = new List<InvAccountDetailsDto>
        {
            ...
            _purchaseQtnMock.Setup(x => x.SavePurchaseQtn(invTransDto, pageId, voucherId)).Returns(new CommonResponse { Exception = null, Data = new InventoryTransactionDto() });
            var result = _purchaseQtnMock.Object.SavePurchaseQtn(invTransDto, pageId, voucherId);
            Assert.That(result, Is.Not.Null);
            Assert.That(result.IsValid, Is.True);
            Assert.That(result.Data, Is.Not.Null);
        }
        [Test]
        public void UpdatePurchaseQtnTest()
        {
            int voucherId = 161;
            int pageId = 526;
            InventoryTransactionDto invTransDto = new InventoryTransactionDto
                ...
                Items = new List<InvTransItemDto>
    {
                    ...
                    Cash = new List<InvAccountDetailsDto>
        {
            ...
            _purchaseQtnMock.Setup(x => x.UpdatePurchaseQuotation(invTransDto, pageId, voucherId)).Returns(new CommonResponse { Exception = null, Data = new InventoryTransactionDto() });
            var result = _purchaseQtnMock.Object.UpdatePurchaseQuotation(invTransDto, pageId, voucherId);
            Assert.That(result, Is.Not.Null);
            Assert.That(result.IsValid, Is.True);
            Assert.That(result.Data, Is.Not.Null);
        }
        ...
        [Test]
        public void DeletePurchaseQtnTest()
        {
            int transId = 31;
            int pageId = 231;
            _purchaseQtnMock.Setup(x => x.DeletePurchaseQuotation(transId, pageId)).Returns(new CommonResponse { Exception = null, Data = new InventoryTransactionDto() });
            var result = _purchaseQtnMock.Object.DeletePurchaseQuotation(transId, pageId);
            Assert.That(result, Is.Not.Null);
            Assert.That(result.IsValid, Is.True);
            Assert.That(result.Data, Is.Not.Null);
