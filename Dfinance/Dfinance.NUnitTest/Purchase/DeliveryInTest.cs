...
{
    public class DeliveryInTest
    {
        private Mock<IDeliveryInService> _deliveryIn;
        [SetUp]
        public void Setup()
        {
            _deliveryIn = new Mock<IDeliveryInService>();
        }
        [Test]
        public void SaveDeliveryInTest()
        {
            int voucherId = 13;
            int pageId = 234;
                ...
                Items = new List<InvTransItemDto>
    {
                    ...
                    Cash = new List<InvAccountDetailsDto>
        {
            ...
            _deliveryIn.Setup(x => x.SaveDeliveyIn(invTransDto, pageId, voucherId)).Returns(new CommonResponse { Exception = null, Data = new InventoryTransactionDto() });
            var result = _deliveryIn.Object.SaveDeliveyIn(invTransDto, pageId, voucherId);
            Assert.That(result, Is.Not.Null);
            Assert.That(result.IsValid, Is.True);
            Assert.That(result.Data, Is.Not.Null);
        }
        [Test]
        public void UpdateDeliveryInTest()
        {
            int voucherId = 13;
            int pageId = 234;
            InventoryTransactionDto invTransDto = new InventoryTransactionDto
                ...
                Items = new List<InvTransItemDto>
    {
                    ...
                    Cash = new List<InvAccountDetailsDto>
        {
            ...
            _deliveryIn.Setup(x => x.UpdateDeliveryIn(invTransDto, pageId, voucherId)).Returns(new CommonResponse { Exception = null, Data = new InventoryTransactionDto() });
            var result = _deliveryIn.Object.UpdateDeliveryIn(invTransDto, pageId, voucherId);
            Assert.That(result, Is.Not.Null);
            Assert.That(result.IsValid, Is.True);
            Assert.That(result.Data, Is.Not.Null);
        }
        [Test]
        public void DeleteDeliveryInTest()
        {
            int transId = 31;
            int pageId = 231;
            _deliveryIn.Setup(x => x.DeleteDeliveryIn(transId, pageId)).Returns(new CommonResponse { Exception = null, Data = new InventoryTransactionDto() });
            var result = _deliveryIn.Object.DeleteDeliveryIn(transId, pageId);
            Assert.That(result, Is.Not.Null);
            Assert.That(result.IsValid, Is.True);
            Assert.That(result.Data, Is.Not.Null);
