...
{
    public class GoodsInTransitTest
    {
        private Mock<IGoodsInTransitService> _goodsInTransit;
        [SetUp]
        public void Setup()
        {
            _goodsInTransit = new Mock<IGoodsInTransitService>();
        }

        [Test]
        public void SaveGoodsInTransitTest()
        {
            int voucherId = 144;
            int pageId = 475;
                ...
                Items = new List<InvTransItemDto>
    {
                    ...
                    Cash = new List<InvAccountDetailsDto>
        {
            ...
            _goodsInTransit.Setup(x => x.SaveGoodsInTransit(invTransDto, pageId, voucherId)).Returns(new CommonResponse { Exception = null, Data = new InventoryTransactionDto() });
            var result = _goodsInTransit.Object.SaveGoodsInTransit(invTransDto, pageId, voucherId);
            Assert.That(result, Is.Not.Null);
            Assert.That(result.IsValid, Is.True);
            Assert.That(result.Data, Is.Not.Null);
        }
        [Test]
        public void UpdateGoodsInTransitTest()
        {
            int voucherId = 144;
            int pageId = 475;
            InventoryTransactionDto invTransDto = new InventoryTransactionDto
                ...
                Items = new List<InvTransItemDto>
    {
                    ...
                    Cash = new List<InvAccountDetailsDto>
        {
            ...
            _goodsInTransit.Setup(x => x.UpdateGoodsInTransit(invTransDto, pageId, voucherId)).Returns(new CommonResponse { Exception = null, Data = new InventoryTransactionDto() });
            var result = _goodsInTransit.Object.UpdateGoodsInTransit(invTransDto, pageId, voucherId);
            Assert.That(result, Is.Not.Null);
            Assert.That(result.IsValid, Is.True);
            Assert.That(result.Data, Is.Not.Null);
        }
        ...
        [Test]
        public void DeleteGoodsInTransitTest()
        {
            int transId = 31;
            int pageId = 231;
            _goodsInTransit.Setup(x => x.DeleteGoodsInTransit(transId, pageId)).Returns(new CommonResponse { Exception = null, Data = new InventoryTransactionDto() });
            var result = _goodsInTransit.Object.DeleteGoodsInTransit(transId, pageId);
            Assert.That(result, Is.Not.Null);
            Assert.That(result.IsValid, Is.True);
            Assert.That(result.Data, Is.Not.Null);
