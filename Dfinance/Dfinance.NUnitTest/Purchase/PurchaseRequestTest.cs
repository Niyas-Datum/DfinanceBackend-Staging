...
namespace Dfinance.NUnitTest.Purchase
{
    ...
    {
        private Mock<IPurchaseRequestService > _purchaseReqMock;
        [SetUp]
        public void Setup()
        {
            _purchaseReqMock = new Mock<IPurchaseRequestService>();
        }
        [Test]
        public void SavePurchaseReqTest()
        {
            int voucherId = 18;
            int pageId = 231;
                ...
                Items = new List<InvTransItemDto>
    {
                    ...
                    Cash = new List<InvAccountDetailsDto>
        {
            ...
            _purchaseReqMock.Setup(x => x.SavePurchaseRequest(invTransDto, pageId, voucherId)).Returns(new CommonResponse { Exception = null, Data = new InventoryTransactionDto() });
            var result = _purchaseReqMock.Object.SavePurchaseRequest(invTransDto, pageId, voucherId);
        ...
        [Test]
        public void UpdatePurchaseReqTest()
        {
            int voucherId = 18;
            int pageId = 231;
            InventoryTransactionDto invTransDto = new InventoryTransactionDto
                ...
                Items = new List<InvTransItemDto>
    {
                    ...
                    Cash = new List<InvAccountDetailsDto>
        {
            ...
            _purchaseReqMock.Setup(x => x.UpdatePurchaseRequest(invTransDto, pageId, voucherId)).Returns(new CommonResponse { Exception = null, Data = new InventoryTransactionDto() });
            var result = _purchaseReqMock.Object.UpdatePurchaseRequest(invTransDto, pageId, voucherId);
            Assert.That(result, Is.Not.Null);
            Assert.That(result.IsValid, Is.True);
            Assert.That(result.Data, Is.Not.Null);
        }
        ...
        [Test]
        public void DeletePurchaseReqTest()
        {
            int transId = 31;
            int pageId = 231;
            _purchaseReqMock.Setup(x => x.DeletePurchaseRequest(transId, pageId)).Returns(new CommonResponse { Exception = null, Data = new InventoryTransactionDto() });
            var result = _purchaseReqMock.Object.DeletePurchaseRequest(transId, pageId);
            Assert.That(result, Is.Not.Null);
            Assert.That(result.IsValid, Is.True);
            Assert.That(result.Data, Is.Not.Null);
