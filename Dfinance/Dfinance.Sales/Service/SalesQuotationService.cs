...
namespace Dfinance.Sales.Service
{
    public class SalesQuotationService : ISalesQuotationService
    {
        ...
        public SalesQuotationService(DFCoreContext context, IAuthService authService, IHostEnvironment hostEnvironment,
            ILogger<SalesQuotationService> logger, IInventoryTransactionService transactionService, IInventoryAdditional inventoryAdditional,
        ...
        public CommonResponse SaveSalesQuotation(InventoryTransactionDto salesDto, int PageId, int voucherId)
        {
        ...
        public CommonResponse UpdateSalesQuotation(InventoryTransactionDto salesDto, int PageId, int voucherId)
        {
            if (!_authService.IsPageValid(PageId))
            {
                return PageNotValid(PageId);
